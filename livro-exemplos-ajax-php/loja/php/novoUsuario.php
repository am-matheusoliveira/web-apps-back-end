...
?>
	<form id="formAjax" action="javascript:void%200" onSubmit="javascript:enviaDados('php/novoUsuario.php'); return false;">
		...
		<p>
			E-mail: <input name="email" type="text" maxlength="100" <?php if(isset($email)) echo "value=\"$email\""; ?>> (seu e-mail será sua identificação no site) 
		</p>

	  	<p>
			Escolha uma senha: <input name="senha" type="password" size="20" maxlength="20">
		</p>

	  	<p>
			Nome completo: <input name="nome" type="text" size="40" maxlength="100" <?php if(isset($nome)) echo "value=\"$nome\""; ?>>
		</p>

	  	<p>
			Endereço: <input name="endereco" type="text" size="50" maxlength="100" <?php if(isset($endereco)) echo "value=\"$endereco\""; ?>>
		</p>
