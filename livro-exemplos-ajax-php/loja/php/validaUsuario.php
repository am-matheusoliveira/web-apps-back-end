...
?>
	...
	<p>
		<a href="javascript:Loja('novoUsuario',0);">SOU CLIENTE NOVO</a>
	</p>

	<form id="formAjax" action="javascript:void%200" onSubmit="enviaDados('php/validaUsuario.php'); return false;">

		<p>JÁ TENHO CADASTRO (digite seus dados)</p>

		<p>
			E-mail: <input name="email" type="text" maxlength="100">
		</p>

		<p>
			Senha: <input name="senha" type="password" size="20" maxlength="20">
		</p>
