<?php
	...
	if(isset($_COOKIE["valorFrete"]) && $_COOKIE["valorFrete"]>0 && isset($_COOKIE["carrinhoAtual"])){
		...
		if(!isset($_COOKIE["carrinhoAtual"]))	// carrinho vazio
			echo "<p class=\"erro\">Seu carrinho está; vazio! Insira os produtos desejados.</p>";
		else	// frete não calculado
			echo "<p class=\"erro\">Você não calculou o frete! Favor escolher o local de entrega.</p>";
