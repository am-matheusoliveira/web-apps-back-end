...
// const customEvent = new Event("keypress", {"bubbles": true, "cancelable": false});
// // INCLUINDO O NOVO EVENTO A O DOCUMENTO-DOM
// // document.dispatchEvent(customEvent);
// document.dispatchEvent(new Event("keypress", {"bubbles": true, "cancelable": false}));
...
function NovoRegistro() {
	...
	if(linhaEmEdicao)
		...
		novasCelulas[2].innerHTML = "<input type='text' id='formato-moeda' name='preco' maxlength='10' onKeyPress='return(FormataMoeda(this, \".\", \",\", event))'>"; // preço		
